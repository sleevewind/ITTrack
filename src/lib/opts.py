...
class opts(object):
    def __init__(self):
        ...
        self.parser.add_argument('--load_model',
                                 default='../models/ctdet_coco_dla_2x.pth',
        ...
        self.parser.add_argument('--num_epochs',
                                 type=int,
                                 default=40,  # 30, 10, 3, 1
                                 help='total training epochs.')
        self.parser.add_argument('--batch_size',
                                 type=int,
                                 default=4,  # 18, 16, 14, 12, 10, 8, 4
                                 help='batch size')
        ...
        self.parser.add_argument(
            '--val_visdrone', default=False, help='val_visdrone')
        self.parser.add_argument(
            '--test_visdrone', default=False, help='test_visdrone')
        self.parser.add_argument(
            '--test_uavdt', default=False, help='test_uavdt')
        self.parser.add_argument(
            '--conf_thres',
            type=float,
            default=0.4,  # 0.6, 0.4
