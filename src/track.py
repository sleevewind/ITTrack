...
import lib.datasets.dataset.jde_ittrack as datasets
...
if __name__ == '__main__':
    ...
    if opt.test_visdrone:
        seqs_str = '''uav0000009_03358_v
                      ...
                      uav0000370_00001_v
                      '''
        data_root = os.path.join(opt.data_dir, 'VisDrone2019/test/images')
    if opt.test_uavdt:
        seqs_str = '''M1401
                      M1303
                      M1302
                      ...
                      M0203
                      '''
        data_root = os.path.join(opt.data_dir, 'UAVDT/test/images')
